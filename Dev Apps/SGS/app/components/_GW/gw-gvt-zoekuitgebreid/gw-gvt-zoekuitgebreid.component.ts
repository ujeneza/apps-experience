...
@Component({
    ...
    templateUrl: "./gw-gvt-zoekuitgebreid.component.html",
    styleUrls: ["./gw-gvt-zoekuitgebreid.component.css"],
    encapsulation: ViewEncapsulation.None
})
export class gwGVTZoekUitgebreidComponent extends GeneralScripts implements OnInit {
    appLabels = appLabels;
    zkForm: FormGroup;
    ...
    zoekVelden: SgsGVTZoekVelden = null;
    @Output() searching: EventEmitter<SgsGVTZoekVelden> = new EventEmitter<SgsGVTZoekVelden>();
    ...
    raiseSearch() {
        this.zoekVelden = new SgsGVTZoekVelden();
